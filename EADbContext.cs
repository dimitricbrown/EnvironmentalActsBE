...
namespace EABackEnd
{
    public class EADbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Event {Id = 1, categoryId = 1, Description = "This Event is to clean up the Stones River", Title = "Clean Up Stones River", ScheduledDate = "10/25/2023", uid = ""}
            });
            modelBuilder.Entity<Category>().HasData(new Category[]
            {
                new Category { Id = 1, Name = "CleanUp"},
